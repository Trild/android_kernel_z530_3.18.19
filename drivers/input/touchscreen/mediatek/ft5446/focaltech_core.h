...
#define TPD_POWER_SOURCE_CUSTOM         	MT6328_POWER_LDO_VGP1 //PMIC_APP_CAP_TOUCH_VDD
 ...
 *for tp esd check
 */
#define GTP_ESD_PROTECT  0  //change by lixh10 
//#define TPD_AUTO_UPGRADE	//wuwl10
/*#define LENOVO_CTP_TEST_FLUENCY //wuwl10 */
/*
...
#define TAG_NAME "FTS_ahe"
#define TPD_DBG(fmt, arg...)    pr_debug(TAG_NAME  " %s: " fmt, __FUNCTION__ ,##arg)
#define TPD_INFO(fmt, arg...)    pr_info(TAG_NAME  "%s: " fmt, __FUNCTION__ ,##arg)

#define FOCALTECH_DBG
#ifdef FOCALTECH_DBG
